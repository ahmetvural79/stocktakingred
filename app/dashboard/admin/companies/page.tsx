...
export default async function CompanyManagementPage() {
  ...
  return (
    <DashboardLayout userName={currentUser.full_name || user.email} userRole={currentUser.role}>
      <div className="p-6">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900">Firma Yönetimi</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-medium text-gray-500">Toplam Firma</span>
            </div>
            <p className="text-3xl font-bold text-gray-900 mt-4">{totalCompanies}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-medium text-gray-500">Toplam Kullanıcı</span>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-medium text-gray-500">Toplam Depo</span>
            </div>
            <p className="text-3xl font-bold text-gray-900 mt-4">{totalWarehouses}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-medium text-gray-500">Sayım Listesi</span>
            </div>
            <p className="text-3xl font-bold text-gray-900 mt-4">{totalSessions}</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-medium text-gray-500">ERP Import</span>
            </div>
            <p className="text-3xl font-bold text-gray-900 mt-4">{totalImports}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Sistemde kayıtlı en son 50 firma listelenir.</p>
            </div>
        ...
        <div className="mt-8 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Genel Analitik</h3>
            <BarChart2 className="h-5 w-5 text-gray-400" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-700">
            <div className="p-4 bg-gray-50 rounded-xl">
              <p className="text-xs text-gray-500 uppercase">Firma Başına Ortalama Kullanıcı</p>
              <p className="mt-2 text-xl font-semibold text-gray-900">
                {totalCompanies > 0 ? (totalUsers / totalCompanies).toFixed(1) : '0'}
              </p>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl">
              <p className="text-xs text-gray-500 uppercase">Firma Başına Depo</p>
              <p className="mt-2 text-xl font-semibold text-gray-900">
                {totalCompanies > 0 ? (totalWarehouses / totalCompanies).toFixed(1) : '0'}
              </p>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl">
              <p className="text-xs text-gray-500 uppercase">Firma Başına Sayım</p>
              <p className="mt-2 text-xl font-semibold text-gray-900">
                {totalCompanies > 0 ? (totalSessions / totalCompanies).toFixed(1) : '0'}
              </p>
            </div>
            <div className="p-4 bg-gray-50 rounded-xl">
              <p className="text-xs text-gray-500 uppercase">Firma Başına ERP Import</p>
              <p className="mt-2 text-xl font-semibold text-gray-900">
